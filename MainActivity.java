    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        seekW.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                if (DynamicIslandService.instance != null) {
                    DynamicIslandService.instance.updateDimensions(prefs.getInt("island_y", 12), progress);
                }
            }
            @Override public void onStartTrackingTouch(SeekBar seekBar) {}
            @Override public void onStopTrackingTouch(SeekBar seekBar) {}
        ...
        btnTest.setOnClickListener(v -> {
            if (DynamicIslandService.instance != null) {
                DynamicIslandService.instance.showIsland("✨ تجربة ناجحة", "الجزيرة متصلة وشغالة 100% 🔥", "🚀", Color.parseColor("#00E676"));
                Toast.makeText(this, "تم تنشيط الجزيرة بنجاح!", Toast.LENGTH_SHORT).show();
            } else {
