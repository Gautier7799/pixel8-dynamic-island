...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnTest.setOnClickListener(v -> {
            startService(new Intent(this, DynamicIslandService.class));
            Intent testIntent = new Intent("com.gaidiamjed.dynamicisland.NOTIF");
            testIntent.putExtra("title", "🎵 Midnight City Beats");
            testIntent.putExtra("text", "مشغل الموسيقى نشط على Pixel 8");
